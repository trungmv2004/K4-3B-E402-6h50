...
| Quality bar bằng con số, nằm trong spec.md commit trước hạn chốt spec (21:00 18/9, tại CP4), giữ nguyên sau đó | 3 |
...
| Mốc | Lớp 3B | Nhóm cần show | TA tích Có/Không |
|---|---|---|---|
| **CP1 · Canvas** | 19:30 17/9 | Canvas 7 dòng (guide §1.5): hướng · job executor · pain 1 câu · 1-2 bằng chứng đầu · lát cắt 1 câu · automation + willing users dự kiến · phân công | ☐ lát cắt đúng format 1 câu ☐ có evidence ban đầu ☐ đủ tên phân công |
| **CP2 · Bấm được** *(mốc hỗ trợ kỹ thuật — nhóm kẹt kỹ thuật gọi TA tại đây)* | 21:00 17/9 | Prototype Sketch/Mock: flow chính bấm đi hết được + commit đầu | ☐ flow chính bấm hết được ☐ repo có commit |
| **CP3 · AI thật + đo lượt đầu** | 16:00 18/9 | **Video 30 giây AI chạy thật** + lời gọi AI thật ở quyết định trung tâm + golden set ≥20 + bảng kết quả lượt 1 có % | ☐ lời gọi AI thật, không hardcode ☐ golden set đủ case khó ☐ bảng đủ mọi case (kết quả thấp không ảnh hưởng — cần ghi nhận đầy đủ, trung thực) |
| **CP4 · Chốt tiến độ** | 21:00 18/9 | Spec gần cuối + báo phần còn thiếu. **Hạn chốt spec: 21:00 18/9, tại CP4; quality bar chốt từ thời điểm này** | ☐ evidence chuẩn A/B có log ☐ bảng impact + ứng viên đã loại ☐ 4 lớp cụ thể ☐ ≥4 nguyên tắc có vị trí áp dụng ☐ quality bar bằng số |
| **CP5 · Nộp cuối: slide PDF + video demo dự phòng** | 22:30 18/9 | **`demo-slides.pdf` + video demo dự phòng** (dùng khi demo live lỗi) + dry run xong. *(Bonus, nếu làm:* feedback log ≥2 người + changelog trong `validation/`.*)* Sau mốc này không nộp thêm | ☐ có PDF + video dự phòng ☐ dry run xong |
| **CP6 · Thuyết trình** | 09:00 19/9 | 5' trình bày (slide 6 trang, có case lỗi live + % vs bar) + 5' Q&A: thẻ giám khảo chạy 1 case lạ tại chỗ; mỗi thành viên nói ≥1 phần | — (vòng demo theo thể lệ sự kiện) |